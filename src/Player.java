...
public Model getRotatedModel() {
		...
		if(super.anInt1520 != -1 && super.anInt1521 != -1) {
			...
			if(model_2 != null) {
				...
				model_3.method469();
				model_3.method470(spotAnim.aAnimation_407.frameIDs[super.anInt1521], nextFrame, cycle1, cycle2);
...
public Model method452()
	{
		if(desc != null)
		{
			...
			if(super.anim >= 0 && super.anInt1529 == 0) {
				...
				currentFrame = animation.frameIDs[super.anInt1527];
				nextFrame = animation.frameIDs[super.nextAnimationFrame];
				cycle1 = animation.delays[super.anInt1527];
			...
			Model model = desc.method164(-1, currentFrame, null);
			return model;
		}
		long l = aLong1718;
		int currentFrame = -1;
