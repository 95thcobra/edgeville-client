...
public final class EntityDef {
	...
	public static EntityDef forID(int i) {
		...
		if (entityDef.interfaceType == 1506) {
			entityDef.name = "Shrimps";
			entityDef.actions = new String[5];
			entityDef.actions[0] = "Small Fishing net";
		}
		if (entityDef.interfaceType == 1507) {
			entityDef.name = "Trout";
			entityDef.actions = new String[5];
			entityDef.actions[0] = "Fly rod";
		}
		if (entityDef.interfaceType == 1508) {
			entityDef.name = "Tuna";
			entityDef.actions = new String[5];
			entityDef.actions[0] = "Harpoon";
		}
		if (entityDef.interfaceType == 1509) {
			entityDef.name = "Swordfish";
			entityDef.actions = new String[5];
			entityDef.actions[0] = "Harpoon";
		}
		if (entityDef.interfaceType == 1510) {
			entityDef.name = "Karambwan";
			entityDef.actions = new String[5];
			entityDef.actions[0] = "Harpoon";
		}
		if (entityDef.interfaceType == 1511) {
			entityDef.name = "Shark";
			entityDef.actions = new String[5];
			entityDef.actions[0] = "Harpoon";
		}
		if (entityDef.interfaceType == 1512) {
			entityDef.name = "Anglerfish";
			entityDef.actions = new String[5];
			entityDef.actions[0] = "Fishing Rod";
		}
		return entityDef;
	}
	...
	private static void dumpDefinitions(int amount) {
