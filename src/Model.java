...
public class Model extends Animable {
	...
	public Model(int modelId) {
		...
		if (modelId == 28300 || modelId == 28301 || modelId == 28302) {
			setTextureNpc(modelId);
		}
	}

	public int faceHasTexture(int face, int modelId) {
		// u gonna cry when u see this
		switch (modelId) {
		case 28300:
	...
	public void method470(int frame, int nextFrame, int end, int cycle) {
		...
		if (anIntArrayArray1657 != null && frame != -1) {
			...
			Skin list1 = currentAnimation.skin;
			anInt1681 = 0;
			anInt1682 = 0;
			anInt1683 = 0;
	...
	public static void printModelColours(Model model) {
		if (model.currentModelColors == null) {
	...
	public void setTextureNpc(int modelId) {
		...
		int assigned = 0;
		for (int i = 0; i < totalModelColors; i++) {
			int tex = faceHasTexture(i, modelId); //i think this is it lets try
			if (tex != -1) {
				currentModelColors[i] = tex;
				anIntArray1637[i] = 3 + set2;
				set2 += 4;
