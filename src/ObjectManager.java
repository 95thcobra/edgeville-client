								...
								if (l18 > 0 || i19 > 0) {
									...
									if (l > 0) {
										...
										if (l18 == 0 && aByteArrayArrayArray136[l][l6][k17] != 0)
											flag = false;
										if (i19 > 0 && !OverlayFloor.overlayFloor[i19 - 1].occlude)
											flag = false;
									...
									if (i19 == 0) {
										...
										OverlayFloor overlay = OverlayFloor.overlayFloor[i19 - 1];
										...
										if (textureId >= 0) {
		                                    ...
		                                    minimapColor = Texture.anIntArray1482[method185(overlay.hslToRgb, 96)];                                
		                                    j23 = -2;
		                                    textureId = -1;
		                                } else {
