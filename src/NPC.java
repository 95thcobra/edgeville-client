...
public final class NPC extends Entity
{
	...
	private Model method450()
	{
		if(super.anim >= 0 && super.anInt1529 == 0)
		{
			...
			int currentFrame = animation.frameIDs[super.anInt1527];
			int nextFrame = animation.frameIDs[super.nextAnimationFrame];
			int cycle1 = animation.delays[super.anInt1527];
			int cycle2 = super.anInt1528;
			//int frame = Animation.anims[super.anim].anIntArray353[super.anInt1527];
			int i1 = -1;
			if(super.anInt1517 >= 0 && super.anInt1517 != super.anInt1511)
				i1 = Animation.anims[super.anInt1517].frameIDs[super.anInt1518];
			return desc.method164(i1, currentFrame, Animation.anims[super.anim].animationFlowControl);
		}
		int currentFrame = -1;
		int nextFrame = -1;
		int cycle1 = 0;
		...
		if(super.anInt1517 >= 0) {
			...
			currentFrame = animation.frameIDs[super.anInt1518];
			nextFrame = animation.frameIDs[super.nextIdleAnimationFrame];
			cycle1 = animation.delays[super.anInt1518];
			cycle2 = super.anInt1519;
		}
		return desc.method164(-1, currentFrame, null);
	}
	...
	public Model getRotatedModel()
	{
		...
		if(super.anInt1520 != -1 && super.anInt1521 != -1)
		{
			...
			if(model_1 != null)
			{
				int j = spotAnim.aAnimation_407.frameIDs[super.anInt1521];
				int nextFrame = spotAnim.aAnimation_407.frameIDs[super.nextGraphicsAnimationFrame];
				int cycle1 = spotAnim.aAnimation_407.frameIDs[super.anInt1521];
